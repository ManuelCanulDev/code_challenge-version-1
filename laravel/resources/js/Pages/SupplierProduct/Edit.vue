...
const form = useForm({
    id: props.supplierProduct.id,
    supplier_id: props.supplierProduct.supplier_id,
    product_id: props.supplierProduct.product_id,
});


const submit = () => {
    form.put(route("supplierProducts.update", props.supplierProduct.id));
};
</script>

<template>
    <Head title="Editar supplierProducts" />

    <BreezeAuthenticatedLayout>
        <template #header>
            <h2 class="text-xl font-semibold leading-tight text-gray-800">
                Editar supplierProducts
            </h2>
        </template>
                    ...
                    <div class="p-6 bg-white border-b border-gray-200">
                        <form @submit.prevent="submit">
                            ...
                            <div class="mb-6">
                                ...
                                <select id="supplier_id" name="supplier_id" v-model="form.supplier_id"
